...
type ComplexityRoot struct {
	...
	Mutation struct {
		Enqueue func(childComplexity int, ip []*model.IP) int
	}

	Query struct {
		GetIPDetails func(childComplexity int, ip model.IP) int
	}
}

type MutationResolver interface {
	Enqueue(ctx context.Context, ip []*model.IP) ([]*model.IPDetails, error)
}
type QueryResolver interface {
	GetIPDetails(ctx context.Context, ip model.IP) (*model.IPDetails, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.enqueue":
		...
		return e.complexity.Mutation.Enqueue(childComplexity, args["ip"].([]*model.IP)), true
	...
	case "Query.getIPDetails":
		...
		return e.complexity.Query.GetIPDetails(childComplexity, args["ip"].(model.IP)), true
...
var sources = []*ast.Source{
	{Name: "schema/schema.graphql", Input: `type IPDetails {
    uuid: ID!
...
func (ec *executionContext) field_Mutation_enqueue_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["ip"]; ok {
		...
		arg0, err = ec.unmarshalNIP2ᚕᚖSpamhausResponseApiᚋmodelᚐIPᚄ(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Query_getIPDetails_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["ip"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("ip"))
		arg0, err = ec.unmarshalNIP2SpamhausResponseApiᚋmodelᚐIP(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_enqueue(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Enqueue(rctx, args["ip"].([]*model.IP))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNIPDetails2ᚕᚖSpamhausResponseApiᚋmodelᚐIPDetailsᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getIPDetails(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetIPDetails(rctx, args["ip"].(model.IP))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.IPDetails)
	fc.Result = res
	return ec.marshalNIPDetails2ᚖSpamhausResponseApiᚋmodelᚐIPDetails(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputIP(ctx context.Context, obj interface{}) (model.IP, error) {
	var it model.IP
...
func (ec *executionContext) unmarshalNIP2SpamhausResponseApiᚋmodelᚐIP(ctx context.Context, v interface{}) (model.IP, error) {
	res, err := ec.unmarshalInputIP(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNIP2ᚕᚖSpamhausResponseApiᚋmodelᚐIPᚄ(ctx context.Context, v interface{}) ([]*model.IP, error) {
	...
	var err error
	res := make([]*model.IP, len(vSlice))
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNIP2ᚖSpamhausResponseApiᚋmodelᚐIP(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNIP2ᚖSpamhausResponseApiᚋmodelᚐIP(ctx context.Context, v interface{}) (*model.IP, error) {
	res, err := ec.unmarshalInputIP(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNIPDetails2SpamhausResponseApiᚋmodelᚐIPDetails(ctx context.Context, sel ast.SelectionSet, v model.IPDetails) graphql.Marshaler {
	return ec._IPDetails(ctx, sel, &v)
}

func (ec *executionContext) marshalNIPDetails2ᚕᚖSpamhausResponseApiᚋmodelᚐIPDetailsᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.IPDetails) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNIPDetails2ᚖSpamhausResponseApiᚋmodelᚐIPDetails(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNIPDetails2ᚖSpamhausResponseApiᚋmodelᚐIPDetails(ctx context.Context, sel ast.SelectionSet, v *model.IPDetails) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
